...
public abstract class JobPlanner {
  ...
  public abstract List<JobConfig> prepareJobs(int i);
  ...
  ExecutionPlan getExecutionPlan(int i) {
    return getExecutionPlan(null, i);
  }

  /* package private */
  ExecutionPlan getExecutionPlan(String runId, int i) {
    ...
    if (!LegacyTaskApplication.class.isAssignableFrom(appDesc.getAppClass())) {
      ...
      generatedConfig.put("app.stage.id", String.valueOf(i));
    }

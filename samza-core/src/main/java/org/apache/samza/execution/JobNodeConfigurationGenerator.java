...
//
//    if (generatedConfig.containsKey("job.name") && mergedConfig.containsKey("job.name")) {
//      if (originalConfig.get("job.name") != generatedConfig.get("job.name")) {
//        mergedConfig.put("job.name", generatedConfig.get("job.name"));
//      }
//    }
